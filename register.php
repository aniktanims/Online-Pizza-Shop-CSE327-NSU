					...
					<div class="card mx-auto registercard">
						...
						<div class="card-text">
							<form action="register.php" method="POST" autocomplete="off">
								...
								<input type="text" name="contact" id="contact" class="form-control registerinput" placeholder="Mobile Number" maxlength="11" value="<?php if(isset($_POST['contact'])){echo($_POST['contact']);} ?>" required>
