...
<body>
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="pb-5">
                <div class="get-started bg-white" onclick="location.href = '/pizza/order.php';"><h4>Order Now</h4><button class = "yellow-button"><i class = "fa fa-angle-right"></i></button></div>
            </div>
        </div>
    </div>
    <!--Header Ends-->
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-12 pt-sm-0 pt-3">
                ...
                <p class="text-center pt-2">
                    <i class="fas fa-phone-alt"></i> +8801797-622-411
                </p>
                <p class="text-center">
                    <i class="fas fa-envelope"></i> mostofa.anik@northsouth.edu
                </p>
            </div>
